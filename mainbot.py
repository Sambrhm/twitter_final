...
while True:
    user = api.get_user('SamIntern')
    api.update_profile(name=f'samaina|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : samaina|{follower_count(user)} Followers')
